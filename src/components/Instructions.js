...
const Instructions = ({ instructions, handleAddInstruction, tags, handleAddTag, setInstructions, setTags }) => {
    ...
    return (
        <div className="md:w-1/5 bg-blue-100 p-4 rounded-lg gap-3 flex flex-col">
            ...
            <Tags tags={tags} handleAddTag={handleAddTag} setTags={setTags} />
